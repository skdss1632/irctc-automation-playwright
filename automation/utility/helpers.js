...
// import { getPassengerData } from "./fetchPassengerData.js";
...
//     await sleepMs(randomDelay(TIMEOUTS.VERY_SHORT, TIMEOUTS.SHORT));
//     try {
//     // Check if "Invalid Captcha...." appears
//     await verifyElementByText({page,
//       text: "Invalid Captcha....",
//       timeout: 300,
//     });

//     console.log("❌ Invalid Captcha detected, retrying...");
//     // If it appears, loop continues automatically

//   } catch (e) {
//     // "Invalid Captcha...." not found → success
...
// }
//   if (!captchaSolved) {
//   throw new Error("❌ Failed to solve CAPTCHA after 6 attempts.");
// }
